...
- [Introduction to Hardware (In)Security with the ChipWhisperer-Nano (ESS 2025)]({% post_url 2025-10-15-ess25-intro-to-hw-insecurity %}) — a workshop demonstrating this attack live using the ChipWhisperer Nano
